...
<div class="flex flex-col">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <form method="POST" action="{{ route('po.store') }}" class="max-w-sm mx-auto my-5">
            @csrf
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900">PO Code</label>
                <input type="text" name="po_code" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-800 focus:border-gray-800 block w-full p-2.5" placeholder="PO.001" required />
            </div>
            <div class="mb-5">
